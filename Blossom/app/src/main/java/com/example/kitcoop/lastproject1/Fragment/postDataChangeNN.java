...
public class postDataChangeNN extends Thread {
    Handler backHandler;
    Handler mainHandler;
    String jsonData;
    String line = "";
    ...
    public postDataChangeNN(Handler mainHandler)
    {
    ...
    public void run() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 500) {
                    ...
                    try {
                        ...
                        String getURL = "http://"+ SharedConstant.IP+"/Tragramer/changenn_json.jsp";
        ...
        System.out.println("백핸들러테스트" + backHandler);
        Looper.loop();
    }
}