        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="tables_dynamic.html" class="site_title"><i class="fa fa-paw"></i> <span>관리자 페이지</span></a>
            </div>
                ...
                <!-- 사이드바 안쓸부븐 -->
                 <!--  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i> 통계 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="chartjs.do">회원통계 </a></li>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="echart_scatter" style="height:450px;"></div>
                  </div>
                </div>
              </div>
              ...
              <!--<div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <canvas id="mybarChart5-2"></canvas>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <canvas id="mybarChart5-3"></canvas>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <canvas id="canvasDoughnut5-1"></canvas>
                  </div>
                </div>
              </div>
            </div> -->
