...
<%@page import="com.exam.mybatis.BlossomTO"%>
<%
	ArrayList<BlossomTO> datas = (ArrayList<BlossomTO>)request.getAttribute("datas");
	
	StringBuffer result = new StringBuffer();

	for(BlossomTO to : datas) {
		result.append("<tr>");
		result.append("<td>" + to.getUsernumber() + "</td>");
		result.append("<td>" + to.getId() + "</td>");
		result.append("<td>" + to.getNickname() + "</td>");
		result.append("<td>" + to.getHeight() + "</td>");
		result.append("<td>" + to.getWeight() + "</td>");
		result.append("<td>" + to.getRegisterdate() + "</td>");
		result.append("</tr>");
	}
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="tables_dynamic.do" class="site_title"><i class="fa fa-paw"></i> <span>관리자 페이지</span></a>
            </div>
                ...
                <!-- 사이드바 안쓸부븐 -->
                 <!--  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-desktop"></i> UI Elements <span class="fa fa-chevron-down"></span></a>
                   ...
                   <!-- href="tables_dynamic.html" 삽입 -->
                  <li><a href="tables_dynamic.do"><i class="fa fa-table"></i> 유저목록<!--  <span class="fa fa-chevron-down"></span> --></a>
                  <!--  <ul class="nav child_menu"> -->
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i> 통계 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="chartjs.do">회원 통계 </a></li>
                      <li><a href="chartjs2.do">새싹 통계</a></li>
                      <li><a href="morisjs.do">걸음 통계</a></li>
                      <li><a href="echarts.do">마신물 통계</a></li>
                      <li><a href="other_charts.do">GPS 통계</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  			<!-- //관리자 이미지 아이콘 -->
                    <img src="${pageContext.request.contextPath}/images/img.jpg" alt="">관리자
